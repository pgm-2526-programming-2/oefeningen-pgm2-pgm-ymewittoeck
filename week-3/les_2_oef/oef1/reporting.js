function displayMoreObscureData(data) {
...
function introduceMoreComplexOperations(data) {
...
function showAdditionalConfusingStatisitcs(highImportanceCount, lowImportanceCount, data) {
...
module.exports = {
    displayMoreObscureData,
    introduceMoreComplexOperations,
    showAdditionalConfusingStatisitcs
}